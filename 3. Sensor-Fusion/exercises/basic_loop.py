...
show_only_frames = [10, 20]  # show only frames in interval for debugging
...
while True:
    try:
        ...
        l1_examples.vis_range_channel(frame, lidar_name, False)

        # Exercise C1-5-5 : Visualize intensity channel
        l1_exercises.vis_intensity_channel(frame, lidar_name, False)

        # Example C1-5-6 : Convert range image to 3D point-cloud
        l1_examples.range_image_to_point_cloud(frame, lidar_name, False)
