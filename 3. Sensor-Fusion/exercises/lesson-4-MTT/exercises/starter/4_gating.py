...
class Association:
    ...
    def get_closest_track_and_meas(self):
        ...
        if min_value is not np.inf:
            ...
            min_index_track = min_index[0]
            min_index_meas = min_index[1]

            # Delete row, col in matrix
            ...
            self.unassigned_tracks.pop(min_index_track)
            self.unassigned_meas.pop(min_index_meas)
