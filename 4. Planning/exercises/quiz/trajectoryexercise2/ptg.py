...
WEIGHTED_COST_FUNCTIONS = [
    (time_diff_cost,    0.5),  # Slightly important: Affects timing precision
    (s_diff_cost,       1.0),  # Important: Affects longitudinal position accuracy
    (d_diff_cost,       1.0),  # Important: Affects lateral position accuracy
    (efficiency_cost,   2.0),  # More important: Affects overall route efficiency
    (max_jerk_cost,     5.0),  # Very important: High impact on comfort and safety
    (total_jerk_cost,   3.0),  # Important: Overall smoothness of the ride
    (collision_cost,    10.0), # Most important: Safety critical
    (buffer_cost,       8.0),  # Very important: Prevents close proximity to other vehicles
    (max_accel_cost,    5.0),  # Very important: Affects comfort and control
    (total_accel_cost,  3.0)   # Important: Overall vehicle dynamics
]
