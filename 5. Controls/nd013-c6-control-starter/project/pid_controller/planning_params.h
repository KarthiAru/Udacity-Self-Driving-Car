...
// Planning Constants
#define P_NUM_PATHS 7 // Default: 7
...
#define P_SLOW_SPEED 1.0               // m/s Default: 1.0
#define P_SPEED_LIMIT 3.0              // m/s Default: 3.0
...
#define P_REACTION_TIME 0.1          // secs Default: 0.25
#define P_NUM_POINTS_IN_SPIRAL 25 // Default: 25
