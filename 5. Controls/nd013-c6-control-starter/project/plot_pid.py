...
def read_steer_data():
 steer_file = LOG_DIR + 'steer_pid_data.txt'
...
def read_throttle_data():
 throttle_file = LOG_DIR + 'throttle_pid_data.txt'
...
def plot_steer_data(steer_df, n_rows):   
 ...
 plt.savefig(LOG_DIR + 'plot-steer.png')  # Saves the plot as a PNG file
#  plt.show()
...
def plot_throttle_data(throttle_df, n_rows):   
 ...
 plt.savefig(LOG_DIR + 'plot-throttle.png')  # Saves the plot as a PNG file
#  plt.show()
